...
public class juegoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dados2=(Button)findViewById(R.id.dados2);
                ...
                public void onClick(View v) {
                    if (position < 37) {
                        ...
                        if (position == 6) {
                            ...
                            Intent mini = new Intent(getApplicationContext(), minijuegoActivity.class);
                            startActivity(mini);
        ...
        dados2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (positiondado2 == 4) {
                    c4.setImageResource(R.drawable.ficha2);points2=points2-30;
                } else if(position==4) {
                    c4.setImageResource(R.drawable.ficha1);
                } else {
                    c4.setImageResource(R.drawable.casilla4);
